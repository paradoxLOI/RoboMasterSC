...
/** 
  * @brief  intake information
  */
typedef __packed struct
{
  uint8_t clamp_success;    /* clamp   success or not */
	uint8_t lift_up_success;  /* lift up success or not */
	uint8_t reverse_success;  /* reverse success or not */
} intake_info_t;
...
/** 
  * @brief  intake control information
  */
typedef __packed struct
{
  uint8_t  intake_high_cmd;      /* intake the high bullet box command */
  uint8_t  intake_low_cmd;       /* intake the low  bullet box command */
} intake_ctrl_t;
...
typedef struct
{
  ...
  intake_info_t     intake_information;
...
typedef struct
{
  ...
  shoot_ctrl_t         shoot_control_data;
	intake_ctrl_t				 intake_control_data;
